...
export const MODAL_BUTTON_TITLES = {
  ...
  [MODAL_KEYS.SNAP_PAN]: APP_CONSTANTS.SAVE_CARD,
  ...
  [MODAL_KEYS.GC_NUMBER]: APP_CONSTANTS.RETRIEVE_GC_BALANCE,
  [MODAL_KEYS.GC_BENEFIT]: APP_CONSTANTS.SUBMIT_GIFT_CARD_PAYMENT,
  [MODAL_KEYS.GC_BALANCE]: APP_CONSTANTS.DONE,
  [MODAL_KEYS.STA_ADD]: APP_CONSTANTS.SAVE_CHARGE_ACCOUNT,
...
export const MODAL_SKIP_BUTTON = {
  ...
  [MODAL_KEYS.DEBIT_CARD_SAVE]: true,
  [MODAL_KEYS.GC_NUMBER]: true,
  [MODAL_KEYS.STA_ADD]: true,
};
...
export const MODAL_SKIP_BUTTON_TITLES = {
  ...
  [MODAL_KEYS.SNAP_CASH]: APP_CONSTANTS.SKIP,
